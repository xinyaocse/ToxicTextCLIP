...
if __name__ == "__main__":
    ...
    options.checkpoints_path = (
        "/root/public/ATRoCLIP/models/binaries/transformer_000000.pth"
    )
    ...
    options.num_beams = 75 # beam size

    options.get_sequences_num = 75 
    options.diversity_penalty = 0.5
    options.num_beam_groups = 15
    ...
    csv_initial_path = os.path.join(csv_root_path,'init_sample')
    output_root_path = os.path.join(csv_root_path, 'generated__by_dbs')
