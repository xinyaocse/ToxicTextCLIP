...
if __name__ == '__main__':
    ...
    # 1.Read the CSV file storing the target image
    df_images = pd.read_csv(target_images_csv_path)


    # 2. Obtain all qualifying captions and shuffle the order
    random.shuffle(captions)
    print(f"find text num: {len(captions)}")
    df_images = df_images.head(50)
    ...
    # Build a poisoned CSV file for training
    csv_file_path = ''
