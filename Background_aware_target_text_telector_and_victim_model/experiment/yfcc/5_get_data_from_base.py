...
yfcc
get top 35 texts
ORI_RoCLIP\minitest\random_select_50_build_base\_6_get_data.py
'''
...
if __name__ == "__main__":
    ...
    attack_csv_path = os.path.join(csv_file_path, 'target.csv')
    if not os.path.exists(attack_csv_path):
        original_train_csv = "yfcc_train.csv"
        shutil.copy2(original_train_csv, attack_csv_path)

    # Create databases and tables
    database_path = "your_task_database_path"
    client = get_database(
    ...
    for image_path,category in image_path_list.items():
        ...
        # caption = processor.process_text(text)
