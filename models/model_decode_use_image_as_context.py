...
class DecoderImageAsContext(nn.Module):
    ...
    def encode(self, pixel_values, text_values):
        ...
        # Remove the marker vector bits from the image representation
    ...
    def process_src_representations_batch(
        ...
        # Process the image representation to make its size consistent with the text representation,
        # in order to provide it to the decoder
        # >>>>>Expect image_representations_batch shape [batchsize,patch_num,dim<512>]
        ...
        # >>>>>Expect text_representations_batch shape [batchsize, 1, dim<512>]
        ...
        # >>>>>finally get src_representations_batch shape [batchsize,patch_num+1,dim<512>]
        src_representations_batch = torch.cat(
            [image_representations_batch, text_representations_batch], dim=1
        )

        # src_representations_batch = text_representations_batch
